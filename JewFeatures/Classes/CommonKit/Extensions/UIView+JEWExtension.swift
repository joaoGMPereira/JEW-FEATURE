...
public extension UIView {
    ...
    func setupDefaultConstraints(parent: UIView, top: CGFloat? = nil, bottom: CGFloat? = nil, leading: CGFloat? = nil, trailing: CGFloat? = nil, useSafeLayout: Bool = false) {
        setupConstraints(parent: parent, top: top, bottom: bottom, leading: leading, trailing: trailing, useSafeLayout: useSafeLayout)
    }
